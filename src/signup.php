...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($user_name) && !empty($password) && !is_numeric($user_name)) {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            $error_message = "Utilizatorul există deja!  <a href='signup.php'>Conectează-te</a>";
        } else {
...
<body>
    ...
    <header>
        ...
        <ul class="menu">
            ...
            <li>
                <a class="icons" id="bag" href="cos.html">
    ...
    <div id="box">
        <form method="post">
            <div style="font-size: 20px; margin: 10px; color: black">Înregistrează-te</div>
            <?php if (!empty($error_message)) : ?>
                <div id="error_message"><?php echo $error_message; ?></div><br>
            <?php endif; ?>
            <input id="text" type="text" name="user_name"><br><br>
            <input id="text" type="password" name="password"><br><br>
            <input id="button" type="submit" value="Înregistrează-te"><br><br>
            <a href="login.php">Conectează-te</a><br><br>
        </form>
    </div>
</body>
